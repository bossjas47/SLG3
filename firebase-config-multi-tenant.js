...
export async function initTenant(user = null) {
    try {
        ...
        if (!claims.websiteId) {
            console.log('⏳ รอ Cloud Function set claims...');
...
export const isTenantAdmin = () => currentUserRole === 'admin';
export const isTenantStaff = () => ['admin', 'staff'].includes(currentUserRole);
